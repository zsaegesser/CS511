...
short src_ln1 [] = {
	  0,  50,  52,  54,  54,  55,  55,  56, 
	 56,  57,  57,  58,  58,  59,  59,  53, 
	 61,  61,  62,  63,  51,  66,  51,  66, 
	 68,  69,  70,  71,  72,  67,  74,  67, 
	 49,  75,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "CR-LEAtest.pml", 1, 33 },
...
short src_ln0 [] = {
	  0,  19,  21,  23,  25,  25,  26,  27, 
	 28,  28,  29,  29,  24,  32,  32,  34, 
	 35,  36,  33,  39,  39,  22,  42,  22, 
	 42,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "CR-LEAtest.pml", 1, 24 },
...
{
	switch (x) {
	case 1: Printf("leader"); break;
	case 2: Printf("elect"); break;
	default: Printf("%d", x);
	}
}
void
