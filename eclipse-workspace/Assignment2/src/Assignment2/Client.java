...
public class Client {
	...
	public void runRoutine() throws InterruptedException {
		for (Exercise e : routine) {
			...
			System.out.println("Client "+this.id+" got apparatus");
			...
			System.out.println("Client "+this.id+" got weighta");
			Gym.mutex.release();
			...
			System.out.println("Client "+this.id+" released apparatus");
			...
			System.out.println("Client "+this.id+" released weights");
